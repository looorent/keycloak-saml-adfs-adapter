...
* Download `dist/keycloak-saml-adfs-adapter-23.0.0.jar` from this repository
...
COPY keycloak-saml-adfs-adapter-23.0.0.jar /opt/keycloak/providers/keycloak-saml-adfs-adapter.jar
```
